...
# Load in data
temp_data <- read_csv("../Imported_Data/temperatures.csv")
...
niue_data <- read_csv("../Imported_Data/Niue_temperature_data.csv", skip = 1)
...
save(temp_data, file = "../Expected/temperature_data_clean.RData")
